...
### 🔑 Login Portal
![Login Portal](./screenshots/03_login_portal.png)

### 👨‍🎓 Student Dashboard & Languages
![Student Languages](./screenshots/04_student_languages.png)

### 📅 Student Calendar & Slot Booking
![Student Calendar](./screenshots/05_student_calendar.png)

### 👤 Student Profile & Present Learning
![Student Profile](./screenshots/06_student_profile.png)

### 📚 Study Materials
![Study Materials](./screenshots/07_student_materials.png)

### 👩‍🏫 Teacher Dashboard
![Teacher Dashboard](./screenshots/08_teacher_dashboard.png)

### 📩 Student Booking Requests
![Teacher Calendar](./screenshots/09_teacher_requests.png)
